...
class E2yunWorkflowModel(models.Model):
    _name = 'e2yun.workflow.model'
    _description = 'E2yun Workflow Model'

    @api.model
    def _compute_default_state(self):
        # Objects
        wkf_obj = self.env['e2yun.workflow']
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        # Code Start
        res = super(E2yunWorkflowModel, self).fields_view_get(view_id=view_id, view_type=view_type, toolbar=toolbar,
                                                               submenu=submenu)
    ...
    def _load_buttons_view(self, view_type, res):
        ...
        def _check_condition_code(btn):
            locals_dict = {
                ...
                'date': date,
                'timedelta': timedelta,
                'workflow': this.env['e2yun.workflow'],
