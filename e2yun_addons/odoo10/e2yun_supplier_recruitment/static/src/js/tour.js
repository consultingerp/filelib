odoo.define('supplier_recruitment.tour', function(require) {
"use strict";
...
tour.register('supplier_recruitment_tour', [{
    trigger: '.o_app[data-menu-xmlid="supplier_recruitment.menu_supplier_recruitment_root"], .oe_menu_toggler[data-menu-xmlid="supplier_recruitment.menu_supplier_recruitment_root"]',
    content: _t('Want to <b>start recruiting</b> like a pro? <i>Start here.</i>'),
    position: 'bottom',
}, {
    trigger: ".oe_kanban_action_button",
    extra_trigger: '.o_supplier_recruitment_kanban',
