...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('odoo.addons.e2yun_hhjc_product_images', "html")
...
class ProductImage(models.Model):
    ...
    # _sql_constraints = [
    #     ('product_template_sort_uniq', 'unique(product_tmpl_id, order_sort)', "SKU 图片顺序 已经存在请核对后再进行添加 !"),
    # ]
...
class ProductTemplate(models.Model):
    ...
    description_editor_ids = fields.One2many('description.editor.row', 'product_tmpl_id', u'描述记录')
