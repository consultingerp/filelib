...
class WebLoginController(webcentercontroller.WebCenterController):
    @http.route('/user_login', type='http', auth='user', methods=['GET', 'POST'], website=True)
    def user_login(self, **kwargs):
        ...
        return request.render("web_user_center.user_login", values)
