    ...
    $.fn.bigic = function () {
        ...
        Bigic.prototype.init = function () {
            ...
            this.$obj.off('.bigic').on('click.bigic', function () {
                ...
                if (sTagName == 'img') {
                    ...
                    var data_img_src = this.getAttribute('data-img');
                    var test= $(data_img_src);
                    oThis.sImgSrc =$("#"+data_img_src).attr('src');
                    oThis.sImgStatus = 'min';
                    // 显示弹窗
                    oThis.show();
                } else {
        ...
        Bigic.prototype.popup = function () {
            ...
            sHtml += '<div id="popupBigic" class="popup-bigic" style="width:' + this.nWinWid + 'px;height:' + this.nWinHei + 'px;">'
                ...
                + '</div>'
                + '<img id="LoadingBigic" class="loading-bigic" src="/web_user_center/static/src/img/preloader.gif" />'
                + '</div>';
            $('body').append(sHtml);
