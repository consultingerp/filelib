...
(function (h, f) {
    ...
    var d, e = +new Date(), a = {}, m = h.extend, n = document.createElement("modernizr").style, k = j(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]), c = j(["flex", "msFlex", "WebkitBoxDirection"]), i = g(),
    ...
    d = h.mobiscroll = h.mobiscroll || {
        version: "2.17.1",
        util: {
            prefix: i, jsPrefix: b, has3d: k, hasFlex: c, isOldAndroid: /android [1-3]/i.test(navigator.userAgent), preventClick: function () {
                d.tapped++;
                setTimeout(function () {
                    d.tapped--
                }, 500)
                ...
                var q = {}, u = s.parent(), t = u.find(".mbsc-err-msg"), v = s.attr("data-icon-align") || "left", r = s.attr("data-icon");
...
(function (i, n, o, h) {
    var e, m, c = i.mobiscroll, j = c.util, b = j.jsPrefix, l = j.has3d, p = j.constrain, d = j.isString, q = j.isOldAndroid, a = /(iphone|ipod|ipad).* os 8_/i.test(navigator.userAgent), f = "webkitAnimationEnd animationend", k = function () {
    }, g = function (r) {
        r.preventDefault()
    };
...
(function (h, k, l, f) {
    var c = h.mobiscroll, g = c.classes, i = c.util, b = i.jsPrefix, j = i.has3d, a = i.hasFlex, d = i.getCoord, m = i.constrain, e = i.testTouch;
    ...
    g.Scroller = function (aj, al, F) {
        ...
        function J(aq) {
            var ap = '<div class="dw-bf">', s = C[aq], p = 1, at = s.labels || [], ao = s.values || [], ar = s.keys || ao;
        ...
        function U(p, ay, s, aA, au) {
            ...
            return {selected: aq, v: aA ? m(aw, an, M) : aw, val: ax.hasClass("dw-v") || aA ? ax.attr("data-val") : null}
        }

        function ak(aq, s, ao, p, ap) {
            if (R("validate", [ai, s, aq, p]) !== false) {
                h(".dw-ul", ai).each(function (av) {
                    var au = h(this), ar = au.closest(".dwwl").hasClass("dwwms"), ax = av == s || s === f, at = U(ac._tempWheelArray[av], au, p, ar, true), aw = at.selected;
                    if (!aw || ax) {
    ...
    g.Scroller.prototype = {
        ...
        _defaults: h.extend({}, g.Frame.prototype._defaults, {
            minWidth: 80, height: 40, rows: 3, multiline: 1, delay: 300, readonly: false, showLabel: true, confirmOnTap: true, wheels: [], mode: "scroller", preset: "", speedUnit: 0.0012, timeUnit: 0.08, formatValue: function (n) {
                return n.join(" ")
    ...
    a.datetime = {
        defaults: {
            ...
            var d = k.shortYearCutoff, f = k.getYear(j), z = k.getMonth(j) + 1, t = k.getDay(j), i = -1, w = j.getHours(), o = j.getMinutes(), g = 0, l = -1, r = false, m = function (s) {
                ...
                m(B);
                var C = (B == "@" ? 14 : (B == "!" ? 20 : (B == "y" ? 4 : (B == "o" ? 3 : 2)))), D = new RegExp("^\\d{1," + C + "}"), s = n.substr(u).match(D);
                if (!s) {
                    return 0
                }
                u += s[0].length;
...
(function (d, f) {
    var b = d.mobiscroll, g = b.datetime, a = new Date(), e = {
        ...
        var X, W, P, B, q, v, Y, ae, j, ak, am = d.extend({}, h.settings), Q = d.extend(h.settings, b.datetime.defaults, e, av, am), r = 0, aA = [], E = [], ab = [], T = {}, D = {}, Z = {y: M, m: an, d: ad, h: L, i: aq, s: H, u: m, a: A}, at = Q.invalid, G = Q.valid, S = Q.preset, l = Q.dateOrder,
            ac = Q.timeWheels, aD = l.match(/D/), I = ac.match(/a/i), ap = ac.match(/h/), ai = S == "datetime" ? Q.dateFormat + Q.separator + Q.timeFormat : S == "time" ? Q.timeFormat : Q.dateFormat, J = new Date(), R = Q.steps || {}, aj = R.hour || Q.stepHour || 1,
            ag = R.minute || Q.stepMinute || 1, af = R.second || Q.stepSecond || 1, ay = R.zeroBased, t = Q.minDate || new Date(Q.startYear, 0, 1), au = Q.maxDate || new Date(Q.endYear, 11, 31, 23, 59, 59), F = ay ? 0 : t.getHours() % aj, C = ay ? 0 : t.getMinutes() % ag,
            y = ay ? 0 : t.getSeconds() % af, aC = z(aj, F, (ap ? 11 : 23)), az = z(ag, C, 59), ax = z(ag, C, 59);
        u = u || ai;
        if (S.match(/date/i)) {
        ...
        function aw(k, aX, aK, a3, aI, aR, a4, a7, aO) {
            var a5, aT, aQ, a2, a1, aN, aL, s, o, aU, aS, aP, aM, a6, p, a0, aZ, aW, aH = {}, aY = {h: aj, i: ag, s: af, a: 1}, aV = Q.getDate(aI, aR, a4), aJ = ["a", "h", "i", "s"];
            if (k) {
        ...
        return {
            wheels: E, headerText: Q.headerText ? function () {
                ...
                var o = al(aB(h.getArrayVal(true)), s), aM = aG(o), aK = ao(aM, "y"), aH = ao(aM, "m"), aL = true, aJ = true;
                        ...
                        if (aS == "d") {
                            ...
                            if (aD) {
                                d(".dw-li", aX).each(function () {
                                    var aY = d(this), a0 = aY.data("val"), i = Q.getDate(aK, aH, a0).getDay(), aZ = l.replace(/[my]/gi, "").replace(/dd/, (a0 < 10 ? "0" + a0 : a0) + (Q.daySuffix || "")).replace(/d/, a0 + (Q.daySuffix || ""));
...
(function (d, f) {
    var c = d.mobiscroll, b = c.util, a = b.isString, e = {batch: 40, inputClass: "", invalid: [], rtl: false, showInput: true, groupLabel: "Groups", checkIcon: "checkmark", dataText: "text", dataValue: "value", dataGroup: "group", dataDisabled: "disabled"};
    c.presetShort("select");
    c.presets.scroller.select = function (M) {
        var j, v, A, L, D, h, O, af, k, t, q, U, H, aj, J, l = {}, ah = {}, C = {}, w = {}, ae = {}, g = d.extend({}, M.settings), W = d.extend(M.settings, e, g), m = W.batch, K = W.layout || (/top|bottom/.test(W.display) ? "liquid" : ""), G = K == "liquid", ag = d(this),
            Q = W.multiple || ag.prop("multiple"), P = b.isNumeric(W.multiple) ? W.multiple : Infinity, S = this.id + "_dummy", y = d('label[for="' + this.id + '"]').attr("for", S), Z = W.label !== f ? W.label : (y.length ? y.text() : ag.attr("name")), u = "dw-msel mbsc-ic mbsc-ic-" + W.checkIcon,
            Y = W.readonly, ai = W.data, R = !!ai, ad = R ? !!W.group : d("optgroup", ag).length, T = W.group, aa = ad && T && T.groupWheel !== false, ac = ad && T && aa && T.clustered === true, B = ad && (!T || (T.header !== false && !ac)), ak = ag.val() || [], V = [], I = {}, E = {}, o = {};
        ...
        M.getValue = z;
        return {
            width: 50, layout: K, headerText: false, anchor: k, confirmOnTap: aa ? [false, true] : true, formatValue: function (an) {
                var al, s, am = [];
                if (Q) {
                    for (al in I) {
                        am.push(E[al] ? E[al].text : "")
                ...
                r(i === f ? ag.val() : i);
                return aa ? [A, U] : [U]
            }, onValueTap: n, onValueFill: x, onBeforeShow: function () {
                if (Q && W.counter) {
