...
class ResConfigSettings(models.TransientModel):
    ...
    app_expiration_date = fields.Datetime('expiration_date')
    app_send_publisher_warranty_url = fields.Boolean('Send publisher warranty url', help=u"send publisher warranty to odoo")
    @api.model
    def get_values(self):
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='https://www.e2yun.cn/documentation/user/12.0/en/index.html')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='https://www.e2yun.cn/documentation/12.0/index.html')
        app_support_url = ir_config.get_param('app_support_url', default='https://www.e2yun.cn/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.e2yun.cn/my-account/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.e2yun.cn')
        app_expiration_date = ir_config.get_param('database.expiration_date', default='2099-06-17 01:45:20')
        app_send_publisher_warranty_url = ir_config.get_param('app_send_publisher_warranty_url', default=False)
        res.update(
            ...
            app_send_publisher_warranty_url=app_send_publisher_warranty_url
        )
        return res
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "https://www.e2yun.cn/documentation/user/12.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "https://www.e2yun.cn/documentation/12.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.e2yun.cn/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.e2yun.cn/my-account/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.e2yun.cn")
        ir_config.set_param("database.expiration_date", self.app_expiration_date or "2099-06-17 01:45:20")
        ir_config.set_param("app_send_publisher_warranty_url", self.app_send_publisher_warranty_url or False)
