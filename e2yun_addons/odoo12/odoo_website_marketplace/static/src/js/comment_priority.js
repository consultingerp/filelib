...
function() {
	...
	if (total_reviews){
		total_reviews = total_reviews.value
	}
	else{
		total_reviews = null
	}
	document.getElementById('rate_tooltip').title=p+' Average Review from '+total_reviews+' Reviews';
...
$(document).ready(function(){	
	var t_comment1 = document.getElementById("total_comment");	
	if (t_comment1) {
		t_comment1 = t_comment1.value
	}	
	else {
		t_comment1 = null
	}
