odoo.define('test_for_input.input_test_report', function (require) {
'use strict';
...
var input_test_report = AbstractAction.extend(ControlPanelMixin, {
    custom_events: {
        search: '_onSearch',
    },
    events:{
...
core.action_registry.add("input_test_report", input_test_report);
return input_test_report;
});
