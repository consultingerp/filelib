...
function load_index_data(area_id){
    $.get('/online_shop/get_index_data', {'area_id':area_id}, function(datas){
        ...
        for(var i = 0;i<recommend_datas.length;i++){
            ...
            "                           <a href='/online_shop/get_product_detail_page/"+p.product_id+"' class='btn btn-outline btn-brw-2' data-animation='fadeInUp' data-duration='.3s' data-delay='.6s'>方案详情</a>\n" +
            "                        </div>\n" +
            "                     </div>\n" +
            "                   </div>\n" +
            "                 </div>\n" +
        ...
        setTimeout(function(){
            jQuery.getScript("/e2yun_sale_online_shop_extends/static/src/assets/js/main.js?_="+ get_timestamp(),function(){
