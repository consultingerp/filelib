...
class OnlineShop(user_info.WebUserInfoController):
                ...
                def get_product_image(product_tmpl_id):
                    ...
                    if product_template_image_object:
                        ...
                        if product_template_image_object:
                            ...
                            return "/e2yun_sale_online_shop_extends/static/src/assets/img/products/prod-04-270x300.jpg"
        ...
        <div class="product-inner">
            ...
            <div class="product-info">
                ...
                <div class="product-info-bottom">
                    ...
                    <a href='javascript:;'  class="list_btn_add_cart btn btn-size-md">联系客服经理</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ft-product-list">
        ...
        if len(product_template_pool) <= 0:
            response_text = "<div>&nbsp;&nbsp;&nbsp;抱歉，没有找到方案额...</div>"
    ...
    <div class="product-action d-flex flex-sm-row align-items-sm-center flex-column align-items-start mb--30">
        ...
        <div>
        <button margin='left' type="button" class="btn btn-size-sm btn-shape-square" onclick="contact()">
            联系客服经理
        </button>"""
            ...
            """+ right_button_text + """
                ...
                response_text = header_text + product.name + middle_text+ footer_text + footer_text2 + footer_text3
                return http.Response(response_text)
...
# class e2yun_sale_online_shop_extends(models.Model):
#     _name = 'e2yun_sale_online_shop_extends.e2yun_sale_online_shop_extends'
