...
class cart(user_info.WebUserInfoController):
    @http.route('/e2yun_sale_online_shop_extends/get_cart_info', type='http', auth="public", website=True)
    ...
    @http.route('/e2yun_sale_online_shop_extends/get_cart_confirm_info', type='http', auth="public", website=True)
    ...
    @http.route('/e2yun_sale_online_shop_extends/get_token', csrf=False,type='http', auth="public")
    def get_token(self,**kwargs):
        return request.make_response(json.dumps({'csrf_token':http.request.csrf_token()}))

    @http.route(['/e2yun_sale_online_shop_extends/ger_cart_qty'], type='http', auth="public", methods=['POST'], website=True,csrf=False)
    ...
    @http.route(['/e2yun_sale_online_shop_extends/add_cart'], type='http', auth="public", methods=['POST'], website=True, csrf=False)
    ...
    @http.route(['/e2yun_sale_online_shop_extends/order_confirm_page'], type='http', auth="public", website=True)
    ...
    @http.route('/e2yun_sale_online_shop_extends/get_order_done_info', type='http', auth="public", website=True)
    ...
    @http.route(['/e2yun_sale_online_shop_extends/order_done_page'], type='http', auth="public", website=True)
    ...
    @http.route(['/e2yun_sale_online_shop_extends/order_confirm'], type='http', auth="public", methods=['POST'], website=True,
                csrf=False)
    ...
    @http.route('/e2yun_sale_online_shop_extends/get_coupon', type='http', auth="public", website=True)
